...
const Home = () => {
  ...
  <div className="p-4 basis-full sm:basis-1/4 flex flex-col">
    ...
    <div className="bg-gradient-to-r from-[#5f4aff8c] via-cyan-50 to-purple-50 rounded-md flex-grow flex items-center justify-center mt-4 drop-shadow-md">
      <img
  ...
  <div className="p-4 basis-full sm:basis-1/4 flex flex-col">
    ...
    <div className="bg-gradient-to-r from-[#5f4aff8c] via-cyan-50 to-purple-50 rounded-md flex-grow flex items-center justify-center mt-4 relative drop-shadow-md">
